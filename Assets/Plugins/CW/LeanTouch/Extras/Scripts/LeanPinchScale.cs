...
namespace Lean.Touch
{
	...
	public class LeanPinchScale : MonoBehaviour
	{
		...
		public float Min { set { minScale = value; } get { return minScale; } } [SerializeField] private float minScale;
		public float Max { set { maxScale = value; } get { return maxScale; } } [SerializeField] private float maxScale;
		...
		protected virtual void Update()
		{
			...
			if (pinchScale != 1.0f)
			{
				...
				// Apply the scale clamp (this ensures the scale stays between minScale and maxScale)
...
namespace Lean.Touch.Editor
{
	...
	public class LeanPinchScale_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			...
			Draw("minScale", "Scale of min.\n\n1 = Default.\n\n2 = Float.");
			Draw("maxScale", "Scale of max.\n\n1 = Default.\n\n2 = Float.");
